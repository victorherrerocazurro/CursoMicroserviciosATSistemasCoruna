...
public class ServiceHumoTest {
	...
	public void consultarPorIdTest() throws Exception {
		mock.perform(get("/Facturas/1")).andExpect(status().is(200));
	}
	@Test
	public void nuevoTest() throws Exception {
		Factura factura = new Factura(0, "Compra Monitor");
	    ...
	    mock
			...
			.andExpect(status().is(201)).andExpect(header().exists("location"));
	}
}