...
public class Configuracion implements WebMvcConfigurer {
	...
	// No es necesario definir, ya que por defecto se dispone de un
	...
	public LocaleChangeInterceptor localeChangeInterceptor() {
		...
		localeChangeInterceptor.setParamName("lang");// Cambiamos el parametro de request que permite el cambio de
														// codigo idiomatico
	...
	// MessageSource: Abstrae la seleccion del mensaje basandose en el codigo
	// idiomatico
	@Bean
